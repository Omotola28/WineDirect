...
public class Website
{
    ...
    public void checkout(Browser buyer)
    {
       ...
       basketOverFull(basket);
       if(basket.size()>= 5 && basketOverFull(basket)== true)
...
//                 counter++;
//             }
//             runningTotal+=wineCase.getPrice()*counter;
//             salesTotal+=wineCase.getPrice()*counter;
//             System.out.printf(counter+ "cases of" +wineCase.getDes()+ "at" +wineCase.getPrice()+ "per case i.e £"+counter*wineCase.getPrice());
//             index++;
//         }
//         System.out.println("");
//         System.out.printf("%-28s%s%6.2f", "The total cost is","£",runningTotal);
